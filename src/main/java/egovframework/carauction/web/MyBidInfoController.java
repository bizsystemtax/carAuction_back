...
public class MyBidInfoController {
	...
	private static final Logger logger = LoggerFactory.getLogger(MyBidInfoController.class);
	...
	//콤보박스 진행상태 조회
	@PostMapping(value = "/bidComboBoxList")
	...
	@PostMapping(value = "/myBidList") 
	public ResultVO myBidList(@RequestBody Map<String, String> requestParams) throws Exception{
		MyPageVO myPageVO = new MyPageVO();
		ResultVO resultVO = new ResultVO();
